...
metadata:
  description: DocGeneratorAgent — mission, stdin/stdout contract, implementation
    rules, DOCX quality rules, table rules, retry policy
  override_by:
  - SYSTEM
  - AGENT
source_file: firestore_utils/uploads/DOC_GENERATOR_COGNITIVE_PROCESS.json
token_id: DOC_GENERATOR_COGNITIVE_PROCESS
    ...
    cognitive_process {
        ...
        rule QA_Checklist() {
            ...
            checklist: [
                ...
                "Checkboxes: items starting with [ ] or [x] must use a semantically appropriate emoji in a TextRun, followed by a tab and the item text — not the raw [ ] / [x] characters.",

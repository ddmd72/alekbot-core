...
metadata:
  ...
  description: Fixed English language policy
  override_by:
  - ACCOUNT
  - USER
  use_case: Users who want bot to always respond in English
  validation:
    action_taken: passed
    adapter: noop
    ...
    risk_score: 0.0
    zone: trusted
source_file: firestore_utils/uploads/LANG_FIXED_EN.json

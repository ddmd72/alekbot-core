...
steps: [
    ...
    "   ",
    "   Example:",
    "   Candidate: \"User's real secret name is 'Bo' (strictly reserved for family)\"",
    "   ",
    "   Keywords: [\"Bo\", \"name\", \"secret\", \"personal\", \"family\", \"reserved\", \"nickname\"]",
    "   Primary: \"User real secret name Bo strictly reserved family personal\"",
    "   Alternative: \"Bo nickname preference family only Robert public name difference\"",
    "   </thinking>",
    "   ",
    "   Call: search_existing_facts(",
    "       keywords=[\"Bo\", \"name\", \"secret\", \"personal\", \"family\", \"reserved\"],",
    "       primary_query=\"User real secret name Bo strictly reserved family personal\",",
    "       alternative_query=\"Bo nickname preference family only Robert public name\",",
    "       limit=20",
    "   )",

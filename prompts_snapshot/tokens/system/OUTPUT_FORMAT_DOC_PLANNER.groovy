...
class: output_format
metadata:
  description: 'DocPlannerAgent — full JSON output schema: all block types, table
    rules, column schema, strictness constraints'
  override_by:
  - SYSTEM
  - AGENT
source_file: firestore_utils/uploads/OUTPUT_FORMAT_DOC_PLANNER.json
token_id: OUTPUT_FORMAT_DOC_PLANNER

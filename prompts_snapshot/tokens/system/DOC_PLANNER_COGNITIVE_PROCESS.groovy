...
metadata:
  description: DocPlannerAgent — mission, default behavior, content policy, document
    design rules, generator handoff
  override_by:
  - SYSTEM
  - AGENT
source_file: firestore_utils/uploads/DOC_PLANNER_COGNITIVE_PROCESS.json
token_id: DOC_PLANNER_COGNITIVE_PROCESS

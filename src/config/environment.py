...
class EnvironmentConfig:
    ...
    @property
    def orchestrator_notes_collection(self) -> str:
        """
        Orchestrator notepad — short-lived cross-turn notes written by Quick/Smart.
        Dev: development_orchestrator_notes
        Prod: orchestrator_notes
        """
        prefix = self.firestore_collection_prefix

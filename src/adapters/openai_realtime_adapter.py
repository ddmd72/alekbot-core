...
# One voice for every call until it becomes a per-user setting. Owner's pick 2026-09-25, after
# cedar (flat intonation) and ballad (not liked) on live calls. Fixed per session once audio is emitted.
_VOICE = "verse"

...
class TestSmartDeduplicationService:
    ...
    def test_different_numbers_not_duplicate(self, service):
        ...
        is_dup, reason = service.is_duplicate(
            ...
            "Weight on 2025-03-28 was 83 kg",
            0.99
        )
    ...
    def test_sorted_numbers_same_values_different_order(self, service):
        ...
        is_dup, reason = service.is_duplicate(
            "Patient: 185 cm height, 83 kg weight",
            "Patient: 83 kg weight, 185 cm height",
            0.97
        )
    ...
    def test_new_more_detailed_not_duplicate(self, service):
        ...
        is_dup, reason = service.is_duplicate(
            "Weight was 83 kg in Puzol, Spain, representing loss of weight",  # New: detailed
            "Weight was 83 kg",  # Existing: short
            0.96
        )
    ...
    def test_new_shorter_is_duplicate(self, service):
        ...
        is_dup, reason = service.is_duplicate(
            "Weight 83 kg",  # New: short
            "Weight was 83 kg in Puzol, Spain",  # Existing: detailed
            0.96
        )
    ...
    def test_weight_change_different_dates(self, service):
        ...
        is_dup, reason = service.is_duplicate(
            "Weight on 2025-03-29 was 83 kg",
            "Weight on 2025-03-28 was 83 kg",
            0.99
        )
    ...
    def test_extract_integers(self, service):
        ...
        numbers = service._extract_and_sort_numbers("Weight 83 kg")
        assert numbers == [83.0]

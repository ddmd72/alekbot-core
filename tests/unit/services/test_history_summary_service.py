...
from src.ports.llm_service import LLMResponse
...
def make_service(response_text: str = None, raise_exc: Exception = None) -> HistorySummaryService:
    ...
    return HistorySummaryService(llm_service=mock_provider, model_name="gemini-flash-preview")
...
class TestHistorySummaryService:
    ...
    async def test_no_retry_on_failure(self):
        ...
        service = HistorySummaryService(llm_service=mock_provider, model_name="model")

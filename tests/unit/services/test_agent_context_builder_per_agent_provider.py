...
def test_strategies_has_no_orphans():
    ...
    # - video_generation: uses VideoGenerationPort, not LLMPort; entry is for provider resolution
    _NON_FACTORY_STRATEGIES = {"email_classifier", "deep_research", "video_generation"}

...
2. Select project: `gen-lang-client-0554950952`
...
gcloud logging read \
  'resource.type="cloud_run_revision" AND resource.labels.service_name="alek-bot-dev" AND severity>=ERROR' \
  --project=gen-lang-client-0554950952 --limit=30 --format=json
...
gcloud logging read \
  ...
  --project=gen-lang-client-0554950952 --freshness=2h --limit=200 --format=json

# All logs for a specific session
gcloud logging read \
  'labels.session_id="<SESSION_ID>"' \
  --project=gen-lang-client-0554950952 --limit=500 --format=json
```
...
gcloud logging read \
  ...
  --project=gen-lang-client-0554950952 --limit=50 --format=json
```

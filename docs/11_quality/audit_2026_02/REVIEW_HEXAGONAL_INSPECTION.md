...
| `GeminiAdapter` | `ports.llm_port.LLMPort` |
| `ClaudeAdapter` | `ports.llm_port.LLMPort` |
...
def __init__(
    ...
    llm_port: Optional[GeminiAdapter] = None,               # <- VIOLATION
...
```python
    ...
    llm_port: Optional[LLMPort] = None,            # port
...
self.llm_port = llm_port or GeminiAdapter(...)                   # line 84

...
- **Ports are the boundaries.** We mock the implementation of Ports (`LLMPort`, `FactRepository`) when testing the Application Layer (`BrainService`, `ConversationHandler`).

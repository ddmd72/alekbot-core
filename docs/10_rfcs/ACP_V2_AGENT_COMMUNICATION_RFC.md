...
```python
# src/ports/llm_port.py (extended)
...
class GeminiAdapter(LLMPort):
    """
    Gemini-specific implementation of LLMPort.
...
class ClaudeAdapter(LLMPort):
    """
    Claude-specific implementation of LLMPort.
...
- `src/ports/llm_port.py` interface docs
...
- [ ] Extend LLMPort with generate_with_tools()

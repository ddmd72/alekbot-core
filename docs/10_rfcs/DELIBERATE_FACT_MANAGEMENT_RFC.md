...
```python
# Existing fact:
"User owns 2005 Mitsubishi Colt"

# User says: "My car has Rain-X"

# Current behavior (BAD):
Creates: "User's car has Rain-X"  # Separate fact

# Desired behavior (GOOD):
Updates existing: "User owns 2005 Mitsubishi Colt with Rain-X and window curtains"
```
...
# Existing facts:
"User owns 2005 Mitsubishi Colt"
"Mitsubishi Colt has Allshift gearbox"
"Car is in Puzol, Spain"

# MERGE →
"User owns 2005 Mitsubishi Colt with Allshift gearbox, based in Puzol, Spain"
```
...
result = await merge_facts(
    ...
    merged_content="User owns 2005 Mitsubishi Colt CZ3 (Plate: AA4431AT) based in Puzol, Spain, with Allshift robotic gearbox, Rain-X, and window curtains",
    metadata={
        "domain": "POSSESSION",
...
{EXISTING_ANCHORS}
    ...
    tools {
        ...
        @tool merge_facts(fact_ids: list, merged_content: str, metadata: dict) {
            ...
            result = merge_facts(
                ...
                merged_content="User owns 2005 Mitsubishi Colt (Plate: AA4431AT) based in Puzol, Spain, with Allshift gearbox, Rain-X, and window curtains",
                metadata={
                    "domain": "POSSESSION",
                    "temporal_class": "STABLE",
                    "state": "CURRENT",
    ...
    examples {
        ...
        example_4_merge_car_details: {
            conversation: "USER: My car has Rain-X and window curtains"

            reasoning: '''
            <thinking>
            STEP 1 - EXTRACT:
            - Candidate: "User's car has Rain-X and window curtains"
            ...
            Results: [
                {
                    fact_id: "car-1",
                    content: "User owns 2005 Mitsubishi Colt",
                    similarity: 0.85
                },
                {
                    fact_id: "car-2",
                    content: "Mitsubishi Colt has Allshift gearbox",
                    similarity: 0.82
                },
                {
                    fact_id: "car-3",
                    content: "Car is in Puzol, Spain",
                    similarity: 0.78
                }
            ]

            STEP 4 - ANALYZE:
            - Multiple facts (3) about SAME entity (Mitsubishi Colt)
...
- SEARCH finds:
  - "User owns 2005 Mitsubishi Colt"
  - "Colt has Allshift gearbox"
  - "Car in Puzol, Spain"
- DECISION: MERGE (3 facts)
- RESULT: "User owns 2005 Mitsubishi Colt with Allshift gearbox, Rain-X, based in Puzol"
